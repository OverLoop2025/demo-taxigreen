...
> sprint posterior) y de **riesgos a vigilar**. Última revisión: **2026-06-03** (auditoría post-cierre S8).
...
| Distancia/ETA real con Directions | Post S8 / MVP | S8 muestra tracking público y mapa/fallback, pero la ETA visible sigue siendo demo estable. Mapbox Directions real queda opcional si se quiere afinar el wow sin arriesgar cierre. |
